...
geanerocha853@gmail.com        </div>
    </div>
    <div className="text-center sm:flex items-center justify-between border-t border-gray-400 mx-[10%] mt-12 py-6">
        <p>© 2024 Geane Rocha todos os direitos reservados.</p>
        <ul className="flex items-center gap-10 justify-center mt-4 sm:mt-0">
            <li><a target='_blank' href="https://github.com/anerocha">GitHub</a></li>
            <li><a target='_blank' href="www.linkedin.com/in/ane-rocha">LinkedIn</a></li>
        </ul>
    </div>
 </div>
  )
